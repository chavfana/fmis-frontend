...
import { Wheat, Beef, Droplets, DollarSign, TrendingUp, AlertTriangle } from 'lucide-react';
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700 mt-1">
                    Heavy rain expected tomorrow. Consider postponing outdoor activities.
                  </p>
                </div>
              </div>
            </div>
